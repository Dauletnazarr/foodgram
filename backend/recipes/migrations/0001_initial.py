# Generated by Django 4.2.17 on 2025-01-08 03:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_link', models.CharField(blank=True, max_length=128, null=True, verbose_name='Короткая ссылка')),
        ...
        migrations.AddField(
            model_name='recipe',
            name='shopping_cart',
            field=models.ManyToManyField(through='recipes.ShoppingCart', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='recipe',
            name='tags',
